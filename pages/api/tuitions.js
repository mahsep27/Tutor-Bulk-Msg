export default async function handler(req, res) {
  ...
  try {
    const url = `https://api.airtable.com/v0/${AIRTABLE_BASE_ID}/Tuitions?fields[]=Custom ID&fields[]=Tuition Ad (Bulk Tutor Msg)&sort[0][field]=Custom ID&sort[0][direction]=asc`;
